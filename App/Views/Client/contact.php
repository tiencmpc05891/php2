		...
		<div class="row justify-content-between">
			<div class="col-lg-5">
				<div class="intro-excerpt">
					<h1>Liên hệ</h1>
					<p class="mb-4">Chúng tôi luôn sẵn lòng lắng nghe và hỗ trợ bạn. Đừng ngần ngại liên hệ với chúng
						tôi để có thêm thông tin chi tiết, tư vấn sản phẩm, hoặc bất kỳ yêu cầu đặc biệt nào khác.</p>
					<p><a href="#"
							class="btn btn-white-outline">Liên hệ ngay</a></p>
				</div>
			</div>
			<div class="col-lg-7">
