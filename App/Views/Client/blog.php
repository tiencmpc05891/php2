		...
		<div class="row justify-content-between">
			<div class="col-lg-5">
				<div class="intro-excerpt">
					<h1>Bài viết</h1>
					<p class="mb-4">Blog của chúng tôi là nơi chia sẻ những ý tưởng và xu hướng nghệ thuật nội thất,
						giúp bạn khám phá thêm về cách tối ưu hóa không gian sống của mình.</p>
					<p><a href="#"
