		...
		<div class="row justify-content-between">
			<div class="col-lg-5">
				<div class="intro-excerpt">
					<h1>Về chúng tôi</h1>
					<p class="mb-4">Chúng tôi là địa điểm tin cậy cho những người đang tìm kiếm sự hoàn hảo trong không
						gian sống của mình. Với đa dạng sản phẩm nội thất và đội ngũ tư vấn chuyên nghiệp.</p>
					<p><a href="#"
							class="btn btn-white-outline">Xem ngay</a></p>
				</div>
			</div>
			<div class="col-lg-7">
...
<div class="why-choose-section">
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-6">
                <h2 class="section-title">Hãy đến với chúng tôi</h2>
                <p>Chúng tôi luôn mang đến sự hoàn hảo tinh tế đến tất cả mọi người, bởi đội ngủ nhân viên chuyên
                    nghiệp.</p>
                ...
                <div class="row my-5">
                    <div class="col-6 col-md-6">
                        <div class="feature">
                            ...
                            <p>Chúng tôi luôn mang đến sự hoàn hảo tinh tế đến tất cả mọi người.
                            </p>
                        </div>
                    </div>
